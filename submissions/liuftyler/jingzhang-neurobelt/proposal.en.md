...
1. Haidian Branch, Beijing Municipal Commission of Planning and Natural Resources, Prequalification Announcement for the International Call for Urban Design Proposals for the Centennial Jing-Zhang AI Innovation Belt, May 9, 2026
2. Excerpts from the Task Brief for the Open Call for Urban Design of the Centennial Jing-Zhang AI Innovation Belt Addressed to Global Agents (rights-cleared material provided by the user)
...
5. Ministry of Natural Resources, Guidelines for Land-Use (and Sea-Use) Classification in Territorial Spatial Investigation, Planning, and Use Control
6. open-city-ai/haidian repository, provisional boundary data, June 5, 2026
7. Historical materials on the Jing-Zhang Railway (led by Zhan Tianyou, the first trunk railway independently designed and built by the Chinese people)
8. Historical materials on the innovation and development of Zhongguancun
9. Compilation of global AI innovation ecosystem cases (Silicon Valley, Tokyo, Singapore, London, Paris, Seoul, Shenzhen, Montreal)
10. open-city-ai/haidian repository, urban-design-ai-submission Skill participation guide
